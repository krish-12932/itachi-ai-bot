...
raw_google_keys = os.getenv("GOOGLE_API_KEY", "")
...
web_domain_env = os.getenv("WEB_DOMAIN", "https://itachi-ai-bot-yxak.onrender.com")
render_url_env = os.getenv("RENDER_EXTERNAL_URL", "https://itachi-ai-bot-yxak.onrender.com")
